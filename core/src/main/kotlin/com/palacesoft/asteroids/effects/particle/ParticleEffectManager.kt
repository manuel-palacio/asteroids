package com.palacesoft.asteroids.effects.particle
 ...
 *
 * TODO: tune .p files in the libGDX 2D Particle Editor:
 *   https://libgdx.com/wiki/tools/2d-particle-editor
 *   Open each .p file, adjust count/velocity/lifetime/tint to taste,
 *   then re-save in place. No code changes needed.
 */
class ParticleEffectManager(private val enabled: Boolean) : Disposable {
    ...
    private fun loadPool(path: String, capacity: Int): ParticleEffectPool? {
        return try {
            ...
            proto.scaleEffect(1f)   // TODO: adjust if world units differ from pixels
